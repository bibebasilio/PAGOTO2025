        ...
        numberInput.addEventListener('change', () => {
            ...
            if (tipo === longit) {
                for (let i = 0; i < miArrayFormato.length; i++) {
                    ...
                    let iidd = ids;
                    const niidd = `${iidd}`;
                    let helado = ['id', niidd, 'nombre', forma + ' ' + gustsab, 'cantidad', 1, 'precio', 800];
                    console.log(helado)
                ...
                alert((' La Cantidad de Gustos === La Cantidad del Formato Elegito') + ('Pulse Fin Seleccion Gustos para continuar ...'));
